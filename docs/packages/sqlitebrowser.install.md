...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/sqlitebrowser.install.svg?label=DB+Browser+for+SQLite+(Install)>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/sqlitebrowser.install.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/sqlitebrowser.install>

## Usage

To install DB Browser for SQLite (Install), run the following command:

```powershell
choco install sqlitebrowser.install
```

To upgrade DB Browser for SQLite (Install), run the following command:

```powershell
choco upgrade sqlitebrowser.install
```

To uninstall DB Browser for SQLite (Install), run the following command:
...
[Chocolatey Package Page](https://community.chocolatey.org/packages/sqlitebrowser.install)
