...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/windowsrepair.svg?label=Windows+Repair>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/windowsrepair.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/windowsrepair>

## Usage

To install Windows Repair, run the following command:

```powershell
choco install windowsrepair
```

To upgrade Windows Repair, run the following command:

```powershell
choco upgrade windowsrepair
```

To uninstall Windows Repair, run the following command:
