...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@9abedd955985420fc0726492cd23345d4c45a9d0/icons/hadoop.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/hadoop.svg?label=Hadoop>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/hadoop.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/hadoop>

## Usage

To install Hadoop, run the following command:

```powershell
choco install hadoop
```

To upgrade Hadoop, run the following command:

```powershell
choco upgrade hadoop
```

To uninstall Hadoop, run the following command:
...
rely on hardware to deliver high-availability, the library itself is designed to
...
The package sets the HADOOP\_HOME environment variable and adds HADOOP\_HOME\bin
to the machine path.

The package by default will unzip to **C:\Hadoop**. This location can be
changed, see below.
