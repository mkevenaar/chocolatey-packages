...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@dd87af3c120e66d0910e9bb71a0c2b9a7acdd334/icons/wireshark.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/wireshark.svg?label=Wireshark>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/wireshark.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/wireshark>
...
To upgrade Wireshark, run the following command:

```powershell
choco upgrade wireshark
```

To uninstall Wireshark, run the following command:
