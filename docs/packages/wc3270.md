...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/wc3270.svg?label=IBM+3270+terminal+emulator>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/wc3270.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/wc3270>

## Usage

To install IBM 3270 terminal emulator, run the following command:

```powershell
choco install wc3270
```

To upgrade IBM 3270 terminal emulator, run the following command:

```powershell
choco upgrade wc3270
```

To uninstall IBM 3270 terminal emulator, run the following command:
