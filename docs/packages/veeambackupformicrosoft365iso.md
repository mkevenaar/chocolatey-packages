# Veeam Backup Microsoft 365 ISO downloader

<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@01ea45baf7311daa91660b5b333acf26aabe9eab/icons/veeam-backup-for-microsoft-365-iso.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/veeam-backup-for-microsoft-365-iso.svg?label=Veeam+Backup+Microsoft+365+ISO+downloader>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/veeam-backup-for-microsoft-365-iso.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/veeam-backup-for-microsoft-365-iso>

## Usage

To install Veeam Backup Microsoft 365 ISO downloader, run the following command:

```powershell
choco install veeam-backup-for-microsoft-365-iso
```

To upgrade Veeam Backup Microsoft 365 ISO downloader, run the following command:

```powershell
choco upgrade veeam-backup-for-microsoft-365-iso
```

To uninstall Veeam Backup Microsoft 365 ISO downloader, run the following
command:
