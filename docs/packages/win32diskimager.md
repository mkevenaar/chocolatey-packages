...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/win32diskimager.svg?label=Win32+Disk+Imager>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/win32diskimager.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/win32diskimager>

## Usage

To install Win32 Disk Imager, run the following command:

```powershell
choco install win32diskimager
```

To upgrade Win32 Disk Imager, run the following command:

```powershell
choco upgrade win32diskimager
```

To uninstall Win32 Disk Imager, run the following command:
