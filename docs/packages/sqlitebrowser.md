...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/sqlitebrowser.svg?label=DB+Browser+for+SQLite>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/sqlitebrowser.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/sqlitebrowser>

## Usage

To install DB Browser for SQLite, run the following command:

```powershell
choco install sqlitebrowser
```

To upgrade DB Browser for SQLite, run the following command:

```powershell
choco upgrade sqlitebrowser
```

To uninstall DB Browser for SQLite, run the following command:
