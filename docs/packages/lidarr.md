...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@34180dba21ceff6da2c9d64cd778bbfbc3bf19c5/icons/lidarr.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/lidarr.svg?label=Lidarr>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/lidarr.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/lidarr>
...
To upgrade Lidarr, run the following command:

```powershell
choco upgrade lidarr
```

To uninstall Lidarr, run the following command:
...
- Can watch for better quality of the tracks you already have and do an
  automatic upgrade.
...
Installs as a service, to get to Lidarr open browser and go to [localhost]:8686
(remove the brackets)
