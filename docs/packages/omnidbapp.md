...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@8668581037bf14d6b31bcfb70156f8a01c816c6a/icons/omnidb-app.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/omnidb-app.svg?label=OmniDB-app>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/omnidb-app.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/omnidb-app>

## Usage

To install OmniDB-app, run the following command:

```powershell
choco install omnidb-app
```

To upgrade OmniDB-app, run the following command:

```powershell
choco upgrade omnidb-app
```

To uninstall OmniDB-app, run the following command:
