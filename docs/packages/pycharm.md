...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@6683bc5c9dc34209811e34594b13ccee6dbf96af/icons/pycharm.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/pycharm.svg?label=JetBrains+Pycharm+Professional>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/pycharm.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/pycharm>

## Usage

To install JetBrains Pycharm Professional, run the following command:

```powershell
choco install pycharm
```

To upgrade JetBrains Pycharm Professional, run the following command:

```powershell
choco upgrade pycharm
```

To uninstall JetBrains Pycharm Professional, run the following command:
