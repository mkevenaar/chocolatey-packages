# Veeam Backup & Replication ISO downloader

<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@c47bdf43fc57a640b409a821fead080042245a3f/icons/veeam-backup-and-replication-iso.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/veeam-backup-and-replication-iso.svg?label=Veeam+Backup+%26+Replication+ISO+downloader>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/veeam-backup-and-replication-iso.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/veeam-backup-and-replication-iso>

## Usage

To install Veeam Backup & Replication ISO downloader, run the following command:

```powershell
choco install veeam-backup-and-replication-iso
```

To upgrade Veeam Backup & Replication ISO downloader, run the following command:

```powershell
choco upgrade veeam-backup-and-replication-iso
```

To uninstall Veeam Backup & Replication ISO downloader, run the following
command:
