...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@047dcebf11a3a9a89dabcbebe2d091111382a619/icons/nsis.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/nsis.install.svg?label=Nullsoft+Scriptable+Install+System+(Install)>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/nsis.install.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/nsis.install>

## Usage

To install Nullsoft Scriptable Install System (Install), run the following
command:
...
To upgrade Nullsoft Scriptable Install System (Install), run the following
command:
...
To uninstall Nullsoft Scriptable Install System (Install), run the following
command:
...
NSIS is script-based and allows you to create the logic to handle even the most
complex installation tasks. Many plug-ins and scripts are already available: you
can create web installers, communicate with Windows and other software
components, install or update shared components and more.
