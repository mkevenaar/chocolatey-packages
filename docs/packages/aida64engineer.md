...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@64bddbe0f873166c0a28485eb187f2be34bdb686/icons/aida64-engineer.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/aida64-engineer.svg?label=AIDA64+Engineer>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/aida64-engineer.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/aida64-engineer>

## Usage

To install AIDA64 Engineer, run the following command:

```powershell
choco install aida64-engineer
```

To upgrade AIDA64 Engineer, run the following command:

```powershell
choco upgrade aida64-engineer
```

To uninstall AIDA64 Engineer, run the following command:
...
AIDA64 Engineer is a cutting-edge system information tool for IT technicians,
which not only provides extremely detailed information about both hardware and
installed software, but also helps users diagnose issues and offers benchmarks
to measure the performance of both workstations and servers.
