...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/mongodb.install.svg?label=MongoDB+(Install)>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/mongodb.install.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/mongodb.install>

## Usage

To install MongoDB (Install), run the following command:

```powershell
choco install mongodb.install
```

To upgrade MongoDB (Install), run the following command:

```powershell
choco upgrade mongodb.install
```

To uninstall MongoDB (Install), run the following command:
