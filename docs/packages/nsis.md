...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/nsis.svg?label=Nullsoft+Scriptable+Install+System>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/nsis.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/nsis>

## Usage

To install Nullsoft Scriptable Install System, run the following command:

```powershell
choco install nsis
```

To upgrade Nullsoft Scriptable Install System, run the following command:

```powershell
choco upgrade nsis
```

To uninstall Nullsoft Scriptable Install System, run the following command:
