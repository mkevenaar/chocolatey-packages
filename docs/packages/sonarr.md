...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@9488a1da3f6e0cbc656374cdc1220aa8e28de542/icons/sonarr.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/sonarr.svg?label=Sonarr>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/sonarr.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/sonarr>
...
To upgrade Sonarr, run the following command:

```powershell
choco upgrade sonarr
```

To uninstall Sonarr, run the following command:
...
grab, sorts and renames them. It can also be configured to automatically upgrade
...
- Can watch for better quality of the episodes you already have and do an
  automatic upgrade. eg. from DVD to Blu-Ray
...
Installs as a service, to get to Sonarr open browser and go to [localhost]:8989
(remove the brackets)
