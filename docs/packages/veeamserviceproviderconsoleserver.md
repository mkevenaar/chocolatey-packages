...
* `/productUpdates` - Specifies if you want to enable automatic update check for managed Veeam products. By default, product updates check is enabled. Example: `/productUpdates:1`
