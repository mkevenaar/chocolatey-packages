...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@56f4b3fcae72ad65ec8184b0dc79d3d9954b8d42/icons/exiftool.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/exiftool.svg?label=ExifTool>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/exiftool.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/exiftool>
...
To upgrade ExifTool, run the following command:

```powershell
choco upgrade exiftool
```

To uninstall ExifTool, run the following command:
...
XMP, JFIF, GeoTIFF, ICC Profile, Photoshop IRB, FlashPix, AFCP and ID3, as well
as the maker notes of many digital cameras by Canon, Casio, FLIR, FujiFilm, GE,
