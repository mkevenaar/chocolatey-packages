...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/superputty.install.svg?label=SuperPutty+(Install)>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/superputty.install.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/superputty.install>

## Usage

To install SuperPutty (Install), run the following command:

```powershell
choco install superputty.install
```

To upgrade SuperPutty (Install), run the following command:

```powershell
choco upgrade superputty.install
```

To uninstall SuperPutty (Install), run the following command:
