...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@ab055ea9be30b03b5238d502f47cd39d362ae0fe/icons/omnidb-server.png"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/omnidb-server.svg?label=OmniDB-server>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/omnidb-server.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/omnidb-server>

## Usage

To install OmniDB-server, run the following command:

```powershell
choco install omnidb-server
```

To upgrade OmniDB-server, run the following command:

```powershell
choco upgrade omnidb-server
```

To uninstall OmniDB-server, run the following command:
