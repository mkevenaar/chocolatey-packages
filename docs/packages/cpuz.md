...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/cpu-z.svg?label=CPU-Z>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/cpu-z.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/cpu-z>

## Usage

To install CPU-Z, run the following command:

```powershell
choco install cpu-z
```

To upgrade CPU-Z, run the following command:

```powershell
choco upgrade cpu-z
```

To uninstall CPU-Z, run the following command:
