...
<img
  src="https://cdn.jsdelivr.net/gh/mkevenaar/chocolatey-packages@010c95a08ae958860af2796ed0a3ad446109f5d7/icons/mediainfo-cli.svg"
  alt="Package icon"
  width="32" height="32"/>
...
[choco-docs-version]: <https://img.shields.io/chocolatey/v/mediainfo-cli.svg?label=MediaInfo+CLI>
[choco-docs-downloads]: <https://img.shields.io/chocolatey/dt/mediainfo-cli.svg>
[choco-docs-package]: <https://community.chocolatey.org/packages/mediainfo-cli>

## Usage

To install MediaInfo CLI, run the following command:

```powershell
choco install mediainfo-cli
```

To upgrade MediaInfo CLI, run the following command:

```powershell
choco upgrade mediainfo-cli
```

To uninstall MediaInfo CLI, run the following command:
