...
https://github.com/mkevenaar/chocolatey-packages/tree/master/extensions/chocolatey-isomount.extension/extensions/Install-ChocolateyIsoInstallPackage.ps1
...
If you need to download the ISO file first, use Install-ChocolateyIsoPackage
instead.
...
publicly (like on the
[community feed](https://community.chocolatey.org/packages)). Otherwise, please
use
...
- [https://mkevenaar.github.io/chocolatey-packages/chocolatey-isomount.extension/HelpersInstallChocolateyIsoInstallPackage.html](https://mkevenaar.github.io/chocolatey-packages/chocolatey-isomount.extension/HelpersInstallChocolateyIsoInstallPackage.html)
...
Get-Help Install-ChocolateyIsoInstallPackage -Full
```

View the source for
[Install-ChocolateyIsoInstallPackage](https://github.com/mkevenaar/chocolatey-packages/tree/master/extensions/chocolatey-isomount.extension/extensions/Install-ChocolateyIsoInstallPackage.ps1)
