...
$url64          = 'https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-7.0.1-rc0-signed.msi'
$checksum64     = 'd951a5682950a153f62818af3d3fe33879729f7fbba847c1662484811b4c6e70'
