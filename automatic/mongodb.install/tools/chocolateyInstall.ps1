...
$url64          = 'https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-7.0.0-rc8-signed.msi'
$checksum64     = 'f2a6cd4ebb57391163f4173a5515dc81577094919c833794c686abe878e9e395'
