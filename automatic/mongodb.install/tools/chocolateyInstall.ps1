...
$url64          = 'https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-8.2.7-rc0-signed.msi'
$checksum64     = '50a3e8e32ec1011be9421013a19bf3ca9b5a01f72cac270597a07da7b4aed08e'
