...
$url64          = 'https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-5.0.0-rc3-signed.msi'
$checksum64     = '2280621261125fd01f1770059145aa26a3db41b67de01dd8519f3489d96f7f07'
