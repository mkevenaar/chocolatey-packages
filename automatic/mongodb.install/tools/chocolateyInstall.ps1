...
$url64          = 'https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-8.0.0-rc7-signed.msi'
$checksum64     = 'de20ad581150a21b73312bc7f1502673970fa9f32a6dc94c7a288969174737b7'
