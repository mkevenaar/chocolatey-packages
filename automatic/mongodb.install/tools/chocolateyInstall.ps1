...
$url64          = 'https://fastdl.mongodb.org/win32/mongodb-win32-x86_64-2012plus-4.2.0-signed.msi'
$checksum64     = 'f1a4f3771563a747a26d8a22990483dcfb6a0f68026672edd5996fdbee35cbcc'
