...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.22.0/codeql-win64.zip'
$checksum = '734fae251a28199ecbfd09675789a4fae4b00523c808b0e2d036e05f5f94245c'
$checksumType = 'sha256'
