...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.26.1/codeql-win64.zip'
$checksum = '5cf2147b2dd17e7ffbdc9904bd049db54c99cb074bdea6f85781caf14ce677c1'
$checksumType = 'sha256'
