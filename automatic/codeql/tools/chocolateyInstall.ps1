...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.27.1/codeql-win64.zip'
$checksum = '6cc7fd668ef4ec9e564842b01863e93c476ddec2de8bba7b40a9697d60098098'
$checksumType = 'sha256'
