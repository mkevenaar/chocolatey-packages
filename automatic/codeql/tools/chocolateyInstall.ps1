...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.23.0/codeql-win64.zip'
$checksum = '13e72f8ea9ab0d496be2f3b22b2f60efca7f6bef0a1b1c9c81ab116183bee9aa'
$checksumType = 'sha256'
