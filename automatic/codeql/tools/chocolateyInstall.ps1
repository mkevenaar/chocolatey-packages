...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.19.3/codeql-win64.zip'
$checksum = '3b41e855b116677738d70ab393b78181d0220cf46b1da88681114175b0fc90ef'
$checksumType = 'sha256'
