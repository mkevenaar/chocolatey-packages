...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.26.2/codeql-win64.zip'
$checksum = '1819f712fea2d06557b729f9074d0d987ecca72d4fe2f06ba32f403ad63d0914'
$checksumType = 'sha256'
