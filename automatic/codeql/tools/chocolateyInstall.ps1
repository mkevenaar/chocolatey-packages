...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.20.0/codeql-win64.zip'
$checksum = 'b62f81fe0746f23d7805e45e021ebd5b3b58fc9f4fab177b42f3319fe6f8bf33'
$checksumType = 'sha256'
