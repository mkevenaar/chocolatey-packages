...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.25.5/codeql-win64.zip'
$checksum = 'db470e09a5f94e9d262f0e1a67af1ff1c72571d567898d3a44c4b09c581afc6e'
$checksumType = 'sha256'
