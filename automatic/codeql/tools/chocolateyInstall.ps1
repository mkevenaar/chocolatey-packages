...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.25.4/codeql-win64.zip'
$checksum = 'ef67924dcca5674d3326ee304c2fd4c97762c94eef9e0a96a807dcb45b8bbf3f'
$checksumType = 'sha256'
