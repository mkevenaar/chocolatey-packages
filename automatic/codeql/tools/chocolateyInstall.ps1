...
$url = 'https://github.com/github/codeql-cli-binaries/releases/download/v2.19.4/codeql-win64.zip'
$checksum = '95bca559e0ffac8134b0d26ee7ccf2ee3e078b9e592201e699dc1c0fc50b9164'
$checksumType = 'sha256'
