...
$url64          = 'https://fastdl.mongodb.org/win32/mongodb-win32-x86_64-2012plus-4.2.8.zip'
$checksum64     = 'e8a410f1e204ca931aaae5b1fa4137f62122fd9981facfe43163e215e8b4f41f'
