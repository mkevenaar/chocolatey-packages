...
$url64          = 'https://fastdl.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-4.0.6.zip'
$checksum64     = 'c99d7fc15f585f10b42db61890686a16ad4066e52ff4491c1363aa0048ebcad0'
