...
$url64          = 'https://fastdl.mongodb.org/win32/mongodb-win32-x86_64-2012plus-4.2.3.zip'
$checksum64     = '4134be6f2fb566f78f9ba55e3d4378c33703483d3a6305fd963baae20635f72a'
