...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.0.0-windows-x86_64.zip'
$checksum     = '31ec38ddb5e05b34cbcd2d3229292d98a37f108dac878ebdf33a5ccbec03bc54'
$checksumType = 'sha256'
$version      = "8.0.0"
