...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.11.2-windows-x86_64.zip'
$checksum     = '05be74a98b4caf611ad89a8cfc0fb56a543995035c8771dd0a84872e0e8b721f'
$checksumType = 'sha256'
$version      = "8.11.2"
