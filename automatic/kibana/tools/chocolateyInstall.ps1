...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.17.28-windows-x86_64.zip'
$checksum     = '77b95506622a283abbe6cc6dc2a98545a4ab2e255b97579a05aac417f0e50983'
$checksumType = 'sha256'
$version      = "7.17.28"
