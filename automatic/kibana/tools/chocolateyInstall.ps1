...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.19.3-windows-x86_64.zip'
$checksum     = '35fed6ebafb1ef104d2b95c41fc6926caa7358ec39a62becfd2e0f4502188521'
$checksumType = 'sha256'
$version      = "8.19.3"
