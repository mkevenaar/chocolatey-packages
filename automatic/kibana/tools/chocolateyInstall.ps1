...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.14.2-windows-x86_64.zip'
$checksum     = '0035af83ed15485335185120307d4954cce496e33d2905a6ab2ed7188c2bf0e3'
$checksumType = 'sha256'
$version      = "8.14.2"
