...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.5.1-windows-x86_64.zip'
$checksum     = 'b251dc432ec29bfb3b87d03c5b2d1f4662606dbdac3d8e4a5a9ad90d310836b3'
$checksumType = 'sha256'
$version      = "9.5.1"
