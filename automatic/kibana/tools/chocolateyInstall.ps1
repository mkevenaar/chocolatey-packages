...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.14.2-windows-x86_64.zip'
$checksum     = '20756cf20ceacc2b646338df5e7a23af07fdda6a0bb0794a9d65ea590bd4c8d8'
$checksumType = 'sha256'
$version      = "7.14.2"
