...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.4.1-windows-x86_64.zip'
$checksum     = '708883caae9bcace92c310f8a56150f07d7d8e2e668b988a507346fd0492450b'
$checksumType = 'sha256'
$version      = "9.4.1"
