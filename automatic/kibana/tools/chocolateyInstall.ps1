...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.4.2-windows-x86_64.zip'
$checksum     = 'a58ed973b76bdb86d9484ba878a9aed326bce5ccba4be42ceee9a77b30cd50c3'
$checksumType = 'sha256'
$version      = "8.4.2"
