...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.10.0-windows-x86_64.zip'
$checksum     = '40e8ae8e8e4c35b56a72356963a65f0be793ade93387d0b176fa7a694c01b571'
$checksumType = 'sha256'
$version      = "8.10.0"
