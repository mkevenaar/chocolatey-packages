...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.13.2-windows-x86_64.zip'
$checksum     = 'dafb79be6ab3061c99714a77be566c0a8f7f27d0cf0b220e2255e6007b738899'
$checksumType = 'sha256'
$version      = "8.13.2"
