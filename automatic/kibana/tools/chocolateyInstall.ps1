...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.3.3-windows-x86_64.zip'
$checksum     = 'f09d94a1b385b19e987e02d366a94c1596915713b09023745d95113ee3eb25c5'
$checksumType = 'sha256'
$version      = "9.3.3"
