...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.13.4-windows-x86_64.zip'
$checksum     = '75f90f252d4b9db1579621c200067f9a7ddb32da80e22f8b101d6ee15fba598b'
$checksumType = 'sha256'
$version      = "7.13.4"
