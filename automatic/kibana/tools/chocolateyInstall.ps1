...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.4.4-windows-x86_64.zip'
$checksum     = '9916914beb958f567de56116877a5528105665fe633a978ae8f16da5ff723ddf'
$checksumType = 'sha256'
$version      = "9.4.4"
