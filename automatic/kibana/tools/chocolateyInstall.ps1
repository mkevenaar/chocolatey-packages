...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.4.6-windows-x86_64.zip'
$checksum     = 'e92b8734b5c5e2ebb1b267a3af2c2bdd36e24a67dae2f93f3bff947161b0b1fc'
$checksumType = 'sha256'
$version      = "9.4.6"
