...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.17.7-windows-x86_64.zip'
$checksum     = '64430380525e5f62925d6041a4abb411ec19d6e5c8f12d13ac6a273cf47d1e8d'
$checksumType = 'sha256'
$version      = "7.17.7"
