...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.4.1-windows-x86_64.zip'
$checksum     = 'fd8fd1ebce7e08d0dfe7ec523e54039acffc70393479ac869663c2b56bfadd6a'
$checksumType = 'sha256'
$version      = "8.4.1"
