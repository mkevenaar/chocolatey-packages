...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.0.0-beta1-windows-x86_64.zip'
$checksum     = '3a196f038895526712fc2972d72ed9c43565d16f97ad1c78a94faea57a3e3c67'
$checksumType = 'sha256'
$version      = "9.0.0-beta1"
