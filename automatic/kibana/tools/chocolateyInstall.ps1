...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.14.0-windows-x86_64.zip'
$checksum     = 'c2bdabd275543538c6e17717fd498e9fae599ca96729d94789ce071d5a155e82'
$checksumType = 'sha256'
$version      = "8.14.0"
