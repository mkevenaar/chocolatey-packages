...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.11.3-windows-x86_64.zip'
$checksum     = '900d9dbfbb90b8a6f99e382351782f1ffd4b8e6b40ad72d2dbda8b696e2cf7a7'
$checksumType = 'sha256'
$version      = "8.11.3"
