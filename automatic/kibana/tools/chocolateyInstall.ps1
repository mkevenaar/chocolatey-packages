...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.3.4-windows-x86_64.zip'
$checksum     = 'c95844cd424a9bf06a29e974a72343de895e505fc4bcc0a23d5abaf3ae52f039'
$checksumType = 'sha256'
$version      = "9.3.4"
