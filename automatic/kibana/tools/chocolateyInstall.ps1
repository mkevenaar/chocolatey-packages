...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.3.6-windows-x86_64.zip'
$checksum     = '0fd1bb40c5ff45dd121aff24bfbaa1a906d137f50ee1a2fb0266b22e8802c26a'
$checksumType = 'sha256'
$version      = "9.3.6"
