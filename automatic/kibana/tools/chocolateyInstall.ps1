...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.2.1-windows-x86_64.zip'
$checksum     = 'b7b003f78d5d80f6f3f41503f75a0958d25df221f6813aca7edda435032e591e'
$checksumType = 'sha256'
$version      = "8.2.1"
