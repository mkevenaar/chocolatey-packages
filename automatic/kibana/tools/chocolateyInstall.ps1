...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.12.2-windows-x86_64.zip'
$checksum     = 'd8392c72b612067cdefd7cca32e2b3a3e85e0d7255d226940352d4dbcb70dfc5'
$checksumType = 'sha256'
$version      = "8.12.2"
