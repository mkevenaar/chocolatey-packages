...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.4.3-windows-x86_64.zip'
$checksum     = '087c1120957bcc184f90233011d085df891cbca547a98200f098a1771c8beabf'
$checksumType = 'sha256'
$version      = "8.4.3"
