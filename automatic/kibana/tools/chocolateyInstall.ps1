...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.11.4-windows-x86_64.zip'
$checksum     = '091dc0b7f9f32587a47ad7bab60e73fad9a219a8dc2c5655e5a452c93139b6bc'
$checksumType = 'sha256'
$version      = "8.11.4"
