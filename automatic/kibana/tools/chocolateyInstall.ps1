...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.17.25-windows-x86_64.zip'
$checksum     = '43f97d3da77840835389db1fd73297ab213c01b9de4098c4c6a875f736927fd1'
$checksumType = 'sha256'
$version      = "7.17.25"
