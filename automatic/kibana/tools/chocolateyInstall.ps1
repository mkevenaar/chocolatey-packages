...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.1.5-windows-x86_64.zip'
$checksum     = '473c7dc9e7f3092ccfdee3ccc75446098095d821a25462af945fa86b43fa29fe'
$checksumType = 'sha256'
$version      = "9.1.5"
