...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.3.3-windows-x86_64.zip'
$checksum     = '09c7b7e88f4d2332e32efb7e80a12e02cbe06e7a7e3650f890d0f0d409b6319a'
$checksumType = 'sha256'
$version      = "8.3.3"
