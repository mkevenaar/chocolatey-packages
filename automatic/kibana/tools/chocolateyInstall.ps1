...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.5.3-windows-x86_64.zip'
$checksum     = 'b92ff8ab8e8485b9dafb5383fb9459bd9377c60df541a6444da16fa07bd6526f'
$checksumType = 'sha256'
$version      = "8.5.3"
