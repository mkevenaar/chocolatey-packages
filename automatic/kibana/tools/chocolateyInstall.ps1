...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.4.2-windows-x86_64.zip'
$checksum     = '098090f9d0a008182f4de558c69ae158ebe002299e5a283025fb3131467328e5'
$checksumType = 'sha256'
$version      = "9.4.2"
