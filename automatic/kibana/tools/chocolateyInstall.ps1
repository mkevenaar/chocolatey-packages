...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.19.0-windows-x86_64.zip'
$checksum     = '6d0fcb6528937e46331eac550def3fc3c3a0ae60633ab6488b5277300d6be454'
$checksumType = 'sha256'
$version      = "8.19.0"
