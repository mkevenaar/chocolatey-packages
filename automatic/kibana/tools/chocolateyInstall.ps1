...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.16.5-windows-x86_64.zip'
$checksum     = '6a995d557ff37ac76fbc4fe2a13226f3150e8a20675802b6b1ea9fc68a914c01'
$checksumType = 'sha256'
$version      = "8.16.5"
