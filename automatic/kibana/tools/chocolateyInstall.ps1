...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.8.2-windows-x86_64.zip'
$checksum     = '7876aa6929e9dc12bf78897e32d474850804bfccd116fab87bf86eedb531b530'
$checksumType = 'sha256'
$version      = "8.8.2"
