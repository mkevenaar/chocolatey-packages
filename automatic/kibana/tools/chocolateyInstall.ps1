...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.16.3-windows-x86_64.zip'
$checksum     = '070a22974dfb54f2008636818caeb91f7f38ab0b9797cc4b3491b57d90047ef5'
$checksumType = 'sha256'
$version      = "7.16.3"
