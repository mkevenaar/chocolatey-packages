...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.9.0-windows-x86_64.zip'
$checksum     = '6f320e2e54aeeadcc18cfec8be28490878b2aff76dc9c122ad2251ec120f13d1'
$checksumType = 'sha256'
$version      = "8.9.0"
