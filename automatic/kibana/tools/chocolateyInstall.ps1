...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.6.1-windows-x86_64.zip'
$checksum     = '686827a72149f4c74f61afe21f21358f575ee3346203106e0e499959aff76bc6'
$checksumType = 'sha256'
$version      = "8.6.1"
