...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.5.2-windows-x86_64.zip'
$checksum     = '8e2e24b187f3fda0031b21f2fcc61309d7f90cd100c0ae92a5a3f85606c2ff69'
$checksumType = 'sha256'
$version      = "9.5.2"
