...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.2.1-windows-x86_64.zip'
$checksum     = '4162bf4619f13b87f980ef21e346de9da958db2059fc0fa91e2a5b0a9a73060f'
$checksumType = 'sha256'
$version      = "9.2.1"
