...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.17.4-windows-x86_64.zip'
$checksum     = '08fb754257468b83df8d97d2182d0d58fbc32fc2f2970534ddfddf31105f31f6'
$checksumType = 'sha256'
$version      = "8.17.4"
