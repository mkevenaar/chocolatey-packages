...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.5.4-windows-x86_64.zip'
$checksum     = '2ec2154fce124bb4cf3b9baab8babc92511daaf602c86492f294dafb3ac3f6e3'
$checksumType = 'sha256'
$version      = "9.5.4"
