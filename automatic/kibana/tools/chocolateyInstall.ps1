...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-9.4.0-windows-x86_64.zip'
$checksum     = '44b88fd4c4abd602447d01b481687d8fd839cd54bb6fe5a0cd9a0e41b1803fc1'
$checksumType = 'sha256'
$version      = "9.4.0"
