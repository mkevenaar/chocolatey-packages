...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.17.15-windows-x86_64.zip'
$checksum     = 'e41ae5fc1001281451bd5584fee7dca6ff067fdd76a38bece96f51d5b50014b0'
$checksumType = 'sha256'
$version      = "7.17.15"
