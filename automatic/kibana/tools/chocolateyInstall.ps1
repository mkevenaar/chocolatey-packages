...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.18.2-windows-x86_64.zip'
$checksum     = 'ad792f1d81250143c1f29948cce8ba2536af1f9de8ce79d40a817ba24879c514'
$checksumType = 'sha256'
$version      = "8.18.2"
