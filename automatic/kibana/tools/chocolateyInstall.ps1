...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.1.2-windows-x86_64.zip'
$checksum     = '320e91a752a863080b6ac215aca79ce6188defb91b929f19d0e294d468d0e4ab'
$checksumType = 'sha256'
$version      = "8.1.2"
