...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.2.2-windows-x86_64.zip'
$checksum     = 'f86c8e2efe1658ee9e9132087116eb4bc7881321668f26ab6faeb1cb9ae91b87'
$checksumType = 'sha256'
$version      = "8.2.2"
