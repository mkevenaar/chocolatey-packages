...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-8.3.2-windows-x86_64.zip'
$checksum     = '77d8e2918784fc6ca1f20203a28d00a8fd43f123b4884741f791cecbd156c416'
$checksumType = 'sha256'
$version      = "8.3.2"
