...
$url          = 'https://artifacts.elastic.co/downloads/kibana/kibana-7.13.1-windows-x86_64.zip'
$checksum     = 'be0496c48f4f6802e3677e611609d31cf0ef1fa0bc1890ffaddea21df4f1ea03'
$checksumType = 'sha256'
$version      = "7.13.1"
