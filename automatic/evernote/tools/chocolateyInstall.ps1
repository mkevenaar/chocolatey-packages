...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.49.4-win-ddl-ga-3782-127ce42593-setup.exe'
$checksum     = 'f9ca92025f406362d0f26b1340be0de9d28ca7aa4f7e0e6caee1d7c489cd8a3c'
$checksumType = 'sha256'
