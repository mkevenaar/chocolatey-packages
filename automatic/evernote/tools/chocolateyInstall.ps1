...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.9.10-win-ddl-ga-2439-setup.exe'
$checksum     = 'c7a9f2be3c0323b4f1a9b74bf3aaf6486307f03dcdcba3362d30905411f9a222'
$checksumType = 'sha256'
