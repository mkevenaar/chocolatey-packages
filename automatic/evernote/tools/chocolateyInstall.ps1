...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.50.9-win-ddl-ga-3838-23ec0e9c2e-setup.exe'
$checksum     = 'a6b5de4f756ebf0729a16335bea34b45073c628c1e9698d5cd6ca3ba31293cd1'
$checksumType = 'sha256'
