...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.14.7-win-ddl-ga-2661-setup.exe'
$checksum     = '85c0e7a953c2e014fc4854c5d8b1c614e32fabbd413fc5931e1b30738cbf6710'
$checksumType = 'sha256'
