...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.26.5-win-ddl-ga-3108-setup.exe'
$checksum     = '5812948fa00ff2863fbf864419cc0d53fcd57472b74224ca42222f9891717817'
$checksumType = 'sha256'
