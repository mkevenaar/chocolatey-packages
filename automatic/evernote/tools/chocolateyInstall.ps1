...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.27.5-win-ddl-ga-3122-setup.exe'
$checksum     = 'a42099624cafb8d677758a1f40bb0d1377264fc504ce00058923fc14ad75af82'
$checksumType = 'sha256'
