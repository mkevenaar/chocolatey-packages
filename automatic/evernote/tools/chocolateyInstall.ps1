...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.58.5-win-ddl-ga-4156-1089b118bb-setup.exe'
$checksum     = 'd94bb1d888e1f64f0b86b63844122355ead85f534be8c0e6feaa1690cfd2f337'
$checksumType = 'sha256'
