...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.20.4-win-ddl-ga-2893-setup.exe'
$checksum     = '9e8093434312a5bd794342d9ac4b7040ac57ccc0688843d7a8c1c658fd308811'
$checksumType = 'sha256'
