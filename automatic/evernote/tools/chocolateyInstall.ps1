...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.18.3-win-ddl-ga-2820-setup.exe'
$checksum     = '1fa07f8b9380294c03aec603f54c421b0e3f46a8e495e46f311606a823e4a7b5'
$checksumType = 'sha256'
