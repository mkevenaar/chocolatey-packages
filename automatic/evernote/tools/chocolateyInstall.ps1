...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.54.4-win-ddl-ga-3978-986a1704b8-setup.exe'
$checksum     = '480af0126fb2a2fe3a8fafc71310de038ee1ebf052ea1fb597d670cd2d40a622'
$checksumType = 'sha256'
