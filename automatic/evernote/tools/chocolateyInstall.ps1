...
$url          = 'https://cdn1.evernote.com/boron/win/builds/Evernote-10.42.7-win-ddl-ga-3561-aac6aeb5e7-setup.exe'
$checksum     = 'c2e0c8b7a5f04867d57157fd2dbeed3b601ad869d9ea7a3e55922adcd01570a7'
$checksumType = 'sha256'
