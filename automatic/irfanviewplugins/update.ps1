...
function global:au_GetLatest {
  ...
  $url32 = "https://www.irfanview.info/files/iview${fileversion}_plugins_setup.exe"
  $url64 = "https://www.irfanview.info/files/iview${fileversion}_plugins_x64_setup.exe"
